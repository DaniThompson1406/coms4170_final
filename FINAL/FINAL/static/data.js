...
// Initialize unlockedRecipes from localStorage
let unlockedRecipes = [];
const unlockedAll = 0;
...
const recipes = [
    ...
    { name: "Macchiato", combo: ["Steamed Milk", "Espresso"], tool: [], 
        ...
        recipe: ["Pull a shot of espresso using 18g of coffee", "Add just a dollop (1oz) of steamed milk on top", "Serve immediately while hot"],
    ...
    { name: "Matcha Latte", combo: ["Matcha Tea", "Steamed Milk"], tool: [], 
        ...
        recipe: ["Whisk 3g of matcha powder with 2oz of hot water", "Pour 6oz of steamed milk over the matcha base", "Gently stir to combine the flavors"],
    ...
    { name: "Latte", combo: ["Espresso", "Steamed Milk"], tool: [],
        ...
        recipe: ["Pull a shot of espresso with 18g of ground coffee", "Steam 6oz of milk until creamy and velvety", "Pour steamed milk over espresso, holding back foam with a spoon", "Finish with a thin layer of microfoam on top"],
    ...
    { name: "Cappuccino", combo: ["Espresso", "Steamed Milk"], tool: [], 
        ...
        recipe: ["Pull a shot of espresso with 18g of ground coffee", "Steam milk to create more foam than a latte", "Pour equal parts steamed milk and foam over espresso"], 
    ...
    { name: "Chai Latte", combo: ["Chai", "Steamed Milk"], tool: [], 
        ...
        recipe: ["Prepare chai tea concentrate with water and chai powder", "Add equal parts steamed milk", "Optionally add honey or sugar to taste"],
    ...
    { name: "Hojicha Latte", combo: ["Hojicha Tea", "Steamed Milk"], tool: [], 
        dosage: ["3g", "6oz", "2oz"], hasRecipe: true, isUnlocked: false,
        recipe: ["Steep 3g of hojicha powder in 2oz hot water", "Add 6oz of steamed milk", "Gently stir to combine"],
    ...
    { name: "Flat White", combo: ["Espresso", "Steamed Milk"], tool: [], 
        ...
        recipe: ["Pull a double shot of espresso (2oz)", "Steam milk to create microfoam texture (less foam than a latte)", "Pour 4oz of steamed milk through the espresso to create a velvety texture"],
        img: "https://raw.githubusercontent.com/DaniThompson1406/coms4170_final/refs/heads/main/FINAL/flat_white.png" }
];

// Initialize recipe unlocked state from localStorage
document.addEventListener('DOMContentLoaded', function() {
    const savedRecipes = localStorage.getItem('unlockedRecipes');
    if (savedRecipes) {
        unlockedRecipes = JSON.parse(savedRecipes);
        
        // Update the isUnlocked status in recipes array
        recipes.forEach(recipe => {
            recipe.isUnlocked = unlockedRecipes.includes(recipe.name);
        });
    }
});